package com.hcl.threadproject.customer;
...
public class Customer {
	...
	/**
	 * <h3>Description :</h3>This overloaded constructor is used to initialize the
	 * Customer object
	 * 
	 * @param customerId   The customer Id of the customer
	 * @param customerName The name of the customer
	 * @param loanAvailed  The status of the customer if he has availed the loan
	 */
	...
	/**
	 * <h3>Description :</h3> The getter method for the customer name
	 * 
	...
	/**
	 * <h3>Description :</h3> The setter method for the customer Name
	 * 
	...
	/**
	 * <h3>Description :</h3> The getter method for the customer loan status
	 * 
	...
	/**
	 * <h3>Description :</h3> The setter method for the customer loan status
	 * 
